...
normal=`tput sgr0`
echo "#########################################################"
echo "This is Version 10 of the Restore Script"
echo "#########################################################"
...
echo ""
restore_methods=("complete (${bold}not${normal} recommended)" "All settings but without home directory (${bold}not${normal} recommended)" "selected setting files and former packages (recommended)" "reinstall former packages only" "only restore Firefox and Thunderbird settings" "only restore Thunderbird settings" "only restore Firefox settings" "Quit") ## array of restoring options
