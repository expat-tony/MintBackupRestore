...
echo ""
restore_methods=("complete (${bold}not${normal} recommended)" "selected setting files and former packages (recommended)" "reinstall former packages only" "only restore Firefox and Thunderbird settings" "Quit") ## array of restoring options
