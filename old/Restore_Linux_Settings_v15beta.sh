#!/bin/bash
#########################################################################################################
# Restore_Linux_Settings V.15beta: Restore Linux Mint settings from >>Backup_Linux_Settings<< script.	#                                          	
#                                                                         								#
...
echo "#########################################################"
echo "This is Version 15beta of the Restore Script"
echo "#########################################################"
...
################################################################################
					"Only restore fstab") # here we don't restore everything, just the fstab.
						...
						echo "Unzipping files into that directory. This can take some time, please be patient."
						sleep 3
						7za x -so $FILENAME | tar xpf - -C $temp_dir --wildcards "etc/fstab"
						echo "Unzipping complete!"
