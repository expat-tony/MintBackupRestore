...
destination="/media/Daten/Linux_Backup/"  # determins the destination folder were the backup will be stored. This is the only variable you should edit if you are not a pro.
...
sleep 1
echo "Now backing up your etc-settings (all of them (including files owned by root)...thats why we are now encrypting)"
sleep 1
