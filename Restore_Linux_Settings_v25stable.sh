...
echo "#########################################################"
echo "This is Version 24beta of the Restore Script"
echo "#########################################################"
...
do
  case $FILENAME in
        ...
        *)
			...
			echo ""
			IFS=$'\t' #this tells the shell to recognize that >>tab<< separates the different options in the restore_methods array (and not space)
